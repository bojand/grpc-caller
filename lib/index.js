 ...
 * @param {Object} defaults - Metadata and Options that will be passed to every Request
 * @returns {Object}
 *
 ...
 *
 * @example <caption>Pass Options, Default Metadata and Interceptor options</caption>
...
function caller (host, proto, name, credentials, options, defaults) {
  ...
  const client = new Ctor(host, credentials || grpc.credentials.createInsecure())
